...
-- CONCURRENTLY removed so this runs cleanly inside supabase db push's transaction pipeline.
-- On a pre-launch / low-traffic database this is equivalent; the indexes are identical.
...
CREATE INDEX IF NOT EXISTS idx_event_participants_user_role
