/**
 * Editorial UI primitives — "Ethereal Architect" design system.
 * Consume via `import { ... } from '@/components/ui/editorial';`
 */
...
export { GoldIconBadge, type GoldIconBadgeProps } from './GoldIconBadge';
export { MinimalInput, type MinimalInputProps } from './MinimalInput';
