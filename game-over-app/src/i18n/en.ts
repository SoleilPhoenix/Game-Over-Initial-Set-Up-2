...
const en = {
  ...
  support: {
    ...
    faq4A: 'Today, the organizer pays Game-Over directly: the non-refundable 25% deposit at booking and the remaining 75% no later than 14 days before the event – by credit card, debit card, Apple Pay, or Google Pay via Stripe. Splitting the cost across the group currently happens outside the app: the app shows each participant their individual share, the organizer can send reminders, and participants reimburse the organizer directly (e.g. bank transfer, PayPal, cash). Direct in-app payment per participant is planned and will follow in a later update.',
    faq5Q: 'Can I cancel my booking?',
    faq5A: 'Yes. You can cancel free of charge up to 14 days before the event and receive a full refund of any amounts already paid. The 25% deposit is non-refundable and secures your booking – if you cancel within 14 days of the event, the deposit is forfeited. The remaining 75%, if already paid, is refunded to the original payment method in that case (5–10 business days). See our Terms & Conditions for full details.',
