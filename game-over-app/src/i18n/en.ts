...
const en = {
  ...
  notifications: {
    ...
    guestProfileUpdatedTitle: 'Guest profile updated',
    guestProfileUpdatedBody: '{{guest}} updated {{fields}}.',
    guestProfileFirstName: 'first name',
    guestProfileLastName: 'last name',
    guestProfilePhone: 'phone',
    guestProfileFieldConjunction: ' and ',
