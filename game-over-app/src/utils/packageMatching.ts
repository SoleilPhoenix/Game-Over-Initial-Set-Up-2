...
interface ActivityDef {
  ...
  seasonal: boolean;
  iceBreaker: boolean;
  /** Placeholder price per person in cents. Used as tiebreaker: lower price wins on equal score.
   *  Final values will be set once provider contracts are confirmed. */
  price_cents: number;
...
export function scoreActivities(answers: QuestionnaireAnswers): ScoredActivity[] {
  ...
  // Sort: primary = score descending, tiebreaker = price ascending (cheaper wins on equal score)
  results.sort((a, b) =>
